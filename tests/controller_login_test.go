...
func TestLogin(t *testing.T) {
	...
	samples := []struct {
		...
		{
			inputJSON:    `{"email": "abboudbath4@gmail.com", "password": "password"}`,
			statusCode:   200,
			errorMessage: "",
		},
		{
			inputJSON:    `{"email": "abboudbath4@gmail.com", "password": "wrong password"}`,
			statusCode:   422,
			errorMessage: "Incorrect Password",
		},
		{
			inputJSON:    `{"email": "hayat@gmail.com", "password": "password"}`,
			statusCode:   422,
			errorMessage: "Incorrect Details",
		},
		{
			inputJSON:    `{"email": "abboudbath.com", "password": "password"}`,
			statusCode:   422,
		...
		{
			inputJSON:    `{"email": "abboudbath4@gmail.com", "password": ""}`,
			statusCode:   422,
